...
class Twilio 
{
     ...
     * @version 1.2.2
     * @author  asterismm <lakshmajee88@gmail.com>
     */
    public function message($message_array, $optional_message = "You got a message form Asterism ", $sms = false , $otp = false, $media = false)
    {
